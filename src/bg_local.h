...
enum
{
	...
	CONFIG_FT_VIEWED_STRING_END = CONFIG_FT_VIEWED_STRING + 63,
	CONFIG_CHASE_STRING,
	CONFIG_CHASE_STRING_END = CONFIG_CHASE_STRING + 63,
	CONFIG_LAST
};
...
enum player_stat_t
{
	...
	STAT_CTF_TEAM4_PIC,
	STAT_CTF_TEAM4_CAPS,
	STAT_CTF_JOINED_TEAM3_PIC,
	STAT_CTF_JOINED_TEAM4_PIC,
	STAT_LAST_ALIVE,
